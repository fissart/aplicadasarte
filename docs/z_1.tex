...
\begin{longtable}[]{@{}c@{}}
\toprule
\includegraphics{ap1.jpeg} \\
\midrule
\endhead
\emph{Componiendo sobre la estructura del rectángulo áureo} \\
\bottomrule
\end{longtable}

\begin{longtable}[]{@{}c@{}}
\toprule
\includegraphics{ap2.jpeg} \\
\midrule
\endhead
\emph{Sin la estructura del rectángulo áureo} \\
\bottomrule
\end{longtable}
...
\hypertarget{softwares-generadores-de-fractales-3d-y-3d}{%
\section{Software's generadores de Fractales 3D y 3D}\label{softwares-generadores-de-fractales-3d-y-3d}}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-2}{}\label{exm:unnamed-chunk-2}En la naturaleza se peden observe muchos ejemplares tales como las nuves los horatlizas
\end{example}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-3}{}\label{exm:unnamed-chunk-3}En la naturaleza se peden observe muchos ejemplares tales como las nuves los hortalizas, etc.
\end{example}
